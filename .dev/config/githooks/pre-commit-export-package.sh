...
# EXPORT_PACKAGE_SHELL_CLI
EXPORT_PACKAGE_REGISTER+=("Shell-CLI")

declare -gA EXPORT_PACKAGE_SHELL_CLI=()
EXPORT_PACKAGE_SHELL_CLI["project_url"]="https://github.com/AeonDigital/Shell-CLI"
EXPORT_PACKAGE_SHELL_CLI["project_name"]="Shell-CLI"
EXPORT_PACKAGE_SHELL_CLI["project_license_type"]="MIT"
EXPORT_PACKAGE_SHELL_CLI["project_license_url"]="LICENSE"
EXPORT_PACKAGE_SHELL_CLI["project_root_path"]="${GIT_HOOK_PROJECT_ROOT_PATH}"
EXPORT_PACKAGE_SHELL_CLI["source_dir_path"]="src/cli"
EXPORT_PACKAGE_SHELL_CLI["assets_dir_path"]=""
EXPORT_PACKAGE_SHELL_CLI["export_file_path"]="package.sh"
EXPORT_PACKAGE_SHELL_CLI["use_autoexec"]="src/cli/main_autoexec.sh"


# EXPORT_PACKAGE_SHELL_CLI_CLIGEN
EXPORT_PACKAGE_REGISTER+=("Shell-CLI-CLIGEN")

declare -gA EXPORT_PACKAGE_SHELL_CLI_CLIGEN=()
EXPORT_PACKAGE_SHELL_CLI_CLIGEN["project_url"]="https://github.com/AeonDigital/Shell-CLI"
EXPORT_PACKAGE_SHELL_CLI_CLIGEN["project_name"]="Shell-CLI-CLIGEN"
EXPORT_PACKAGE_SHELL_CLI_CLIGEN["project_license_type"]="MIT"
EXPORT_PACKAGE_SHELL_CLI_CLIGEN["project_license_url"]="LICENSE"
EXPORT_PACKAGE_SHELL_CLI_CLIGEN["project_root_path"]="${GIT_HOOK_PROJECT_ROOT_PATH}"
EXPORT_PACKAGE_SHELL_CLI_CLIGEN["source_dir_path"]="src/cligen"
EXPORT_PACKAGE_SHELL_CLI_CLIGEN["assets_dir_path"]=""
EXPORT_PACKAGE_SHELL_CLI_CLIGEN["export_file_path"]="cligen_package.sh"
EXPORT_PACKAGE_SHELL_CLI_CLIGEN["use_autoexec"]=""