...
# shell_cli_metaflag_property_validate_required - validate structural integrity of this metaflag.
#
# Arguments
...
# shell_cli_metaflag_check_input_required - runtime input check placeholder for this metaflag.
#
# Arguments
