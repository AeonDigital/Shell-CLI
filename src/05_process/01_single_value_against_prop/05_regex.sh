...
# shell_cli_process_flag_single_value_against_prop_regex - Process the active single value against a regular expression pattern.
#
# Arguments
...
#
# Notes
# - Leverages 'shell_cli_metaflag_check_input_regex' internally to evaluate pattern conformity.
...
# - 1: Failure (value breaks format rules or fails to match the regular expression pattern).
