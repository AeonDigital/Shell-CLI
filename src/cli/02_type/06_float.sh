...
# - Does not enforce numeric conversion; if the input is not a valid float, the original
#   string is returned unchanged.
# 
# Global Outputs:
# - SHELL_CLI_FN_RETURN: String containing the normalized float candidate.
# 
# Returns:
