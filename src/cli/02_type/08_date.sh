...
# - Does not guarantee that the resulting string is a valid date; only ensures a
#   consistent format when possible.
# 
# Global Outputs:
# - SHELL_CLI_FN_RETURN: String containing the standardized date formatting.
# 
# Returns:
...
# - Converts the parsed timestamp back to "YYYY-MM-DD" and compares with the original
#   input to ensure structural validity.
