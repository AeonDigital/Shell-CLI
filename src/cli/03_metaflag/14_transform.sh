...
# shell_cli_metaflag_property_validate_transform — validate structural integrity
# of this metaflag.
# 
# Arguments
...
# shell_cli_metaflag_check_input_transform — runtime input check placeholder for
# this metaflag.
# 
# Arguments
