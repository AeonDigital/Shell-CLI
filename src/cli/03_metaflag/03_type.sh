...
# shell_cli_metaflag_property_validate_type — validate structural integrity of this
# metaflag.
# 
# Arguments
...
# shell_cli_metaflag_check_input_type — runtime input check placeholder for this
# metaflag.
# 
# Arguments
