...
# shell_cli_metaflag_property_validate_is_assoc — validate structural integrity of
# this metaflag.
# 
# Arguments
...
# shell_cli_metaflag_check_input_is_assoc — runtime input check placeholder for this
# metaflag.
# 
# Arguments
