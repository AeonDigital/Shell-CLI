...
# shell_cli_utils_array_indexed_clone — clones the specified indexed array into a
# new indexed array with the provided name.
# 
# Arguments:
...
# shell_cli_utils_array_assoc_clone — clones the specified associative array into
# a new associative array with the provided name.
# 
# Arguments:
