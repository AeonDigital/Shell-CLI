...
# - val2: The second string decimal number acting as the boundary threshold. Supports
#   the same negative/decimal formatting as val1.
...
shell_cli_utils_math_compare_float() {
  ...
  if [[ "${sign1}" != "${sign2}" ]]; then
    ...
    # If both evaluate mathematically to 0 (e.g. -0.0 vs 0.0), proceed to equality
    # check
  fi
...
# shell_cli_utils_math_is_greater_or_equal — asserts if val1 is higher or equal than
# val2 bounds.
# 
# Arguments:
...
# shell_cli_utils_math_is_less_or_equal — asserts if val1 is lower or equal than
# val2 bounds.
# 
# Arguments:
# - val1: The first string decimal number to compare.
...
# shell_cli_utils_math_is_greater_than — asserts if val1 is strictly greater than
# val2 bounds.
# 
# Arguments:
# - val1: The first string decimal number to compare.
...
# shell_cli_utils_math_is_less_than — asserts if val1 is strictly less than val2
# bounds.
# 
# Arguments:
# - val1: The first string decimal number to compare.
